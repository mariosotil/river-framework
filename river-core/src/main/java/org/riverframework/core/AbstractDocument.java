...
public abstract class AbstractDocument<T extends AbstractDocument<T>>
   ...
   */
  protected static boolean numericEquals(List<String> vector1, List<String> vector2) {
    ...
    Iterator<String> it1 = vector1.iterator();
  ...
  /**
   * @return the table where the document belongs. If this method is not overrided, it will returns
   * the simple name of the current class.
   */
  @Override
  ...
  /**
   * Verifies if the new value is different from the field's old value. It's useful, for example, in
   * NoSQL databases that replicates data between servers. This verification prevents to mark a
   * field as modified and to be replicated needlessly.
   *
  ...
  public boolean compareFieldValue(String field, Object value) {
    ...
    List<String> oldValues = getField(field);
    List<String> newValues = null;

    if (value instanceof java.util.List) {
      newValues = (List<String>) value;
  ...
  public Map<String, List<String>> getFields() {
    ...
    Map<String, List<String>> result = _doc.getFields();
    return result;
  }
  ...
  public List<String> getField(String field) {
    ...
    List<String> value = _doc.getField(field);
    return value;
  }

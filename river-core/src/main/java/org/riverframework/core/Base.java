...
public interface Base {
	...
	/**
	 * Returns the object wrapped by the wrapper class. Considering that a wrapper wraps a library that it would be used to access natively
	 * to the NoSQL server, it is very possible that the core object does not have specific operations. In that case, the access to the
	 * referenced object will allow to do it.
	 * 

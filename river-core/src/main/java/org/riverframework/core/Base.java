...
/**
 * It is used to define some common methods to Session, Database, Document and
 * View interfaces.
 * 
...
public interface Base {
	/**
	 * Returns the id from the object instanced. Its behavior will depend on how
	 ...
	 * NoSQL server, it is very possible that the core object does not have
	 * specific operations. In that case, the access to the referenced object
	 * will allow to do it.
	 * 

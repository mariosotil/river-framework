...
public interface Database extends Base {
	...
	/**
	 * Creates an instance from the clazz class. The parameters needed will depend in what wrapper is being used.
	 * 
	 * @param clazz
	...
	/**
	 * Returns an instance from the clazz class. The parameters needed will depend on what wrapper is being used.
	 * 
	 * @param clazz
	 *            a class that extends the AbstractView core class
	 * @param parameters
	...
	/**
	 * Returns a closed instance from the clazz class, as a Null Object Pattern. The method isOpen() will return false.
	 * 
	 * @param clazz
	 *            a class that extends the AbstractView core class
	 * @return a closed view.
	...
	/**
	 * Returns a Document object. The class is detected from the object doc using the rules defined from the classes
	 * registered at the database, using registerDocumentClass.
	 * 
	 * @param _doc
	 ...
	 *            a class that extends the AbstractDocument core class
	 * @param parameters
	 *            a set of Strings that will let the Database locate an existent Document.
	 * @return a DefaultDocument instance.
	 */
	...
	/**
	 * Returns the documents that match the query as a DocumentIterator object. The style of the query depends on how is
	 * implemented in the wrapper loaded. For example, in IBM Notes is just something like "Black AND Dog". The max
	 * parameter will indicate how much documents could retrieve the method. It will depend on what wrapper is being
	 * used.
	 * 
	 * @param query
	 *            the query written in the format expected by the wrapper.
	 * @param max
	 *            the maximum number of documents retrieved by the method. A zero value will retrieve all that the
	 *            wrapper allows to do it.
	 * @return a DocumentIterator document
	 */

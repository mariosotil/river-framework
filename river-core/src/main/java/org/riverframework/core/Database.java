...
public interface Database extends Base {
   ...
   *
   * @param parameters a set of Strings that will let the Database create a Document.
   ...
   *
   * @param parameters a set of Strings that will let the Database creates a new View.
   * @return a DefaultView object
   */
  public View createView(String... parameters);

  /**
   * Creates an instance from the clazz class. The parameters needed will depend in what wrapper is
   * being used.
   *
   * @param clazz a class that extends the AbstractView core class
   * @param parameters a set of Strings that will let the Database creates a new View.
   ...
   *
   * @param parameters a set of Strings that will let the Database get an existent View.
   * @return a DefaultView object
   */
  public View getView(String... parameters);

  /**
   * Returns an instance from the clazz class. The parameters needed will depend on what wrapper is
   * being used.
   *
   * @param clazz a class that extends the AbstractView core class
   * @param parameters a set of Strings that will let the Database creates a new View.
  ...
  /**
   * Returns a closed view, as a Null Object Pattern. Its method isOpen() will return false.
   *
  ...
  /**
   * Returns a closed instance from the clazz class, as a Null Object Pattern. The method isOpen()
   * will return false.
   *
   * @param clazz a class that extends the AbstractView core class
   * @return a closed view.
   ...
   *
   * @param parameters a set of Strings that will let the Database locate an existent new Document.
   * @return the Document found. If no document is found, the method returns a closed Document
   * object
   */
   ...
   *
   * @param createIfDoesNotExist if true, the document will be created.
   * @param parameters a set of Strings that will let the Database locate an existent new Document.
  ...
  /**
   * Returns a Document object. The class is detected from the object doc using the rules defined
   * from the classes registered at the database, using registerDocumentClass.
   *
   * @param _doc a wrapper Document object
   ...
   *
   * @param clazz a class that extends the AbstractDocument core class
   * @param parameters a set of Strings that will let the Database creates a new Document.
   * @return a DefaultDocument instance.
   */
   ...
   *
   * @param clazz a class that extends the AbstractDocument core class
   * @param parameters a set of Strings that will let the Database locate an existent Document.
   * @return a DefaultDocument instance.
   */
  public <U extends AbstractDocument<?>> U getDocument(Class<U> clazz, String... parameters);

  /**
   * Returns an instance from the clazz class, with the option to created it if can't be found.
   *
   * @param clazz a class that extends the AbstractDocument core class
   * @param createIfDoesNotExist if true, the document will be created.
   * @param parameters a set of Strings that will let the Database locate an existent Document.
  ...
  /**
   * Returns a closed document, as a Null Object Pattern. Its method isOpen() will return false.
   *
  ...
  /**
   * Returns the documents that match the query as a DocumentIterator object. The style of the query
   * depends on how is implemented in the wrapper loaded. For example, in IBM Notes is just
   * something like "Black AND Dog"
   *
   * @param query the query written in the format expected by the wrapper.
   * @return a DocumentIterator document
   */
   ...
   * Returns the documents that match the query as a DocumentIterator object. The style of the query
   * depends on how is implemented in the wrapper loaded. For example, in IBM Notes is just
   * something like "Black AND Dog". The max parameter will indicate how much documents could
   * retrieve the method. It will depend on what wrapper is being used.
   *
   * @param query the query written in the format expected by the wrapper.
  ...
  /**
   * Refresh the database index. How this index is refreshed will depend on how is implemented in
   * the wrapper loaded.
   *
   * @param createIfDoesNotExist if the index does not exist, set true to force to be created.
  ...
  /**
   * Returns the file path where the database is allocated. The String returned will depend on how
   * is implemented the wrapper loaded.
   *
  ...
  /**
   * Returns the database name. The String returned will depend on how is implemented the wrapper
   * loaded.
   *

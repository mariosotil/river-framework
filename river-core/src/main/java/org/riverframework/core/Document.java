...
/**
 * This interface exposes the methods for control a document from a NoSQL
 * database.
 * 
...
public interface Document extends Base {
	...
	/**
	 * Set a field with the indicated value. If the field does not exist, it
	 * will create it.
	 * 
	 * @param field
	 *            the field to be set
	...
	/**
	 * Returns the values of a field as a Vector object. If the field does not
	 * exist or is empty, it will returns an empty Vector.
	 * 
	 * @param field
	 *            the field to be get
	...
	/**
	 * Returns the value of a field as a String object. If the field is an
	 * array, it will returns the first value. If the field does not exist or is
	 * empty, it will returns an empty string.
	 * 
	 * @param field
	 *            the field to be get
	...
	/**
	 * Returns the value of a field as an integer. If the field is an array, it
	 * will returns the first value. If the field does not exist or is empty, it
	 * will returns 0.
	 * 
	 * @param field
	 *            the field to be get
	...
	/**
	 * Returns the value of a field as a long. If the field is an array, it will
	 * returns the first value. If the field does not exist or is empty, it will
	 * returns 0.
	 * 
	 * @param field
	 *            the field to be get
	...
	/**
	 * Returns the value of a field as a double. If the field is an array, it
	 * will returns the first value. If the field does not exist or is empty, it
	 * will returns 0.
	 * 
	 * @param field
	...
	/**
	 * Returns the value of a field as a date. If the field is an array, it will
	 * returns the first value. If the field does not exist or is empty, it will
	 * returns null.
	 * 
	 * @param field
	...
	/**
	 * Returns true if the field does not exists or is an empty string, zero or
	 * null.
	 * 
	 * @param field
	...
	/**
	 * Returns true is any field of this document was changed since the last
	 * save.
	 * 
	...
	/**
	 * Returns true if the Document was recently created and still has not been
	 * saved.
	 * 
	...
	/**
	 * Makes a hard deletion. Its behavior will depend on how the wrapper loaded
	 * is implemented.
	 * 
	 * @return the same Document, for method chaining
	 */
	...
	/**
	 * Saves the Document asking if it has to force it or do it only if the
	...
	/**
	 * Saves the Document. Its behavior will depend on how the wrapper loaded is
	 * implemented.
	 * 
	 * @return the same Document, for method chaining
	 */
	...
	/**
	 * Requests a Document recalculation. Its behavior will depend on how the

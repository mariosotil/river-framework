...
public interface Document extends Base {
  ...
  /**
   * @return the binder where the document belongs.
   */
   ...
   *
   * @param field the field that value will be compared
  ...
  /**
   * Returns the values of a field as a Vector object. If the field does not exist or is empty, it
   * will returns an empty Vector.
   *
  ...
  /**
   * Returns the value of a field as a String object. If the field is an array, it will returns the
   * first value. If the field does not exist or is empty, it will returns an empty string.
   *
   * @param field the field to be get
  ...
  /**
   * Returns the value of a field as an integer. If the field is an array, it will returns the first
   * value. If the field does not exist or is empty, it will returns 0.
   *
   * @param field the field to be get
  ...
  /**
   * Returns the value of a field as a long. If the field is an array, it will returns the first
   * value. If the field does not exist or is empty, it will returns 0.
   *
   * @param field the field to be get
  ...
  /**
   * Returns the value of a field as a double. If the field is an array, it will returns the first
   * value. If the field does not exist or is empty, it will returns 0.
   *
   * @param field the field to be get
  ...
  /**
   * Returns the value of a field as a date. If the field is an array, it will returns the first
   * value. If the field does not exist or is empty, it will returns null.
   *
   * @param field the field to be get
   ...
   *
   * @param clazz it extends the AbstractDocument core class.

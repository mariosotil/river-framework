...
public interface IndexedDocument<T> extends Document {
	/**
	 * This method helps the framework to know what is the field used as key in
	 * the index. It must be defined at the inheriting class and returns the
	 * field name. e.g. "ca_person_id"
	 * 
	...
	/**
	 * This method helps the framework to know what is the view used as index.
	 * It must be defined at the inheriting class and returns the view name.
	 * e.g. "vi_persons"
	 * 
	 ...
	 * it.
	 * 
	 * @return a View object with the index. The object will be closed if it is
	 ...
	 * it. If it could not be found, it will return a closed view object.
	 * 
	 * @return a DefaultView object for the index. The object will be closed if

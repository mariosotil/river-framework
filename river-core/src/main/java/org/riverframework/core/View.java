...
public interface View extends Base {
	 ...
	 *
	 * @param <U>
	 *            a class that inherits from AbstractDocument and implements
	 *            Document.
	 * @param clazz
	 *            a class object that inherits from AbstractDocument and
	 *            implements Document.
	 * @param key
	 *            the document's key
	 ...
	 *         closed.
	 */
	public <U extends org.riverframework.core.AbstractDocument<?>> U getDocumentByKey(
	 ...
	 * @param isSorted
	 *            if it is true, the column will be created as a ascending
	 *            sorted column

 ...
 * @version 0.0.x
 */
class DefaultDocument extends AbstractBaseWrapper<DocumentMock> implements org.riverframework.wrapper.Document<DocumentMock> {
    ...
    protected DefaultDocument(org.riverframework.wrapper.Session<SessionMock> _session, DocumentMock __native) {
    ...
    public String calcObjectId(DocumentMock __doc) {
        String objectId = "";
        if (__doc != null) {
            String documentId = getDocumentId();

            try {
                DatabaseMock __database = __doc.getParentDatabase();
    ...
    @Override
    public Document<DocumentMock> setBinder(String table) {
        setField("Form", table);
        return this;
    }
    ...
    @Override
    public Document<DocumentMock> setField(String field, Object value) {
	    /*
		Vector temp = null;
...
*/
    ...
    @Override
    public Document<DocumentMock> recalc() {
        try {
    ...
    @Override
    public Document<DocumentMock> delete() {
    ...
    @Override
    public Document<DocumentMock> save() {
        try {

...
public abstract class AbstractStressTest {
	...
	public void testStress1() {
		...
		Database<?> _database = _session.createDatabase(context.getTestDatabaseServer(), "TEST_DB_2_" + suffixDb);
	...
	public void testStress2() {
		...
		String suffixDb = sdf.format(new Date()) + ".nsf";
		Database<?> db1 = _session.createDatabase(context.getTestDatabaseServer(), "TEST_DB_1_" + suffixDb);
		...
		Database<?> db2 = _session.createDatabase(context.getTestDatabaseServer(), "TEST_DB_2_" + suffixDb);

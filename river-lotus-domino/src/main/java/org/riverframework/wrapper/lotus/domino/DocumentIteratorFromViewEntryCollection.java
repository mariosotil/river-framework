...
class DocumentIteratorFromViewEntryCollection extends AbstractBase<lotus.domino.ViewEntryCollection> implements DocumentIterator<lotus.domino.ViewEntryCollection, lotus.domino.Document> {

...
public abstract class AbstractViewTest {
  ...
  public void testGetDocumentIterator() {
    ...
    assertFalse("There is a problem with the database. There are still documents after the delete.",
        _it.hasNext());
  ...
  public void testSearch() {
    ...
    for (int i = 0; i < 10; i++) {
      _database.createDocument().setField("Form", TEST_FORM).setField("Text", "I_AM_THE_" + i)
          .save();
    }
